...
export class FrontendComponent implements OnInit {
  ...
  sites = [
    { id: 0, imgUrl: './assets/images/site-aimotive.png', siteUrl: 'https://aimotive.com/', visible: true, title: 'aimotive', text: `During my four years at AIMOTIVE the company has grown from 16 to around 300 employees. Just as the internal management sites, the main page also had to go through a big evolution to support the needs of this dinamic change. My work related to this company is quite complex. I was not only responsible for developing and designing most of the UI's, but also created the foundations of the brand's full appearance.` },
    ...
    { id: 2, imgUrl: './assets/images/site-adris.png', siteUrl: 'https://adriskitchen.hu/', visible: false, title: `Adri'sKitchen`, text: 'This project turned out quite a complex one. Careful and detailed planning was really important to save time, in the later in the development phase. The site has many features that does not meet the eyes at first, such as timed content or a sweepstake module for social media. The logo became especially good in my opinion.' },
